...
async function fetchMoviesOnNav(input) {
  const URL = `https://api.themoviedb.org/3/movie/${input}?&include_adult=false&language=en-US&page=1`;
...
export default fetchMoviesOnNav;
